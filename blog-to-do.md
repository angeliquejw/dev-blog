...
* Deal with some build warnings:
  [x] Using deprecated markdown-it-anchor permalink option, see https://github.com/valeriangalliat/markdown-it-anchor#permalinks
- SASS:
...
[x] Attempt switching from Sass to CSS?
[ ] Replace minimage
