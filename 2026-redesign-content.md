...
> She's the kind of leader who makes everyone around her better. Strategic enough to see the whole picture, detailed enough to never let things fall through the cracks, and kind enough to make the hard work feel worth it. She has a rare ability to take a messy, ambiguous situation and bring clarity and momentum to it without losing the people in the process.

> As her direct report, I found her management style to be relaxed, focused, and pragmatic. [...] She was always welcoming and most concerned with what she could do to empower her charges and how projects and processes could be tweaked to deliver faster, better results. To that end, the trust she placed in her subordinates was immensely reassuring and gratifying, as we always felt we had the autonomy to make recommendations and drive changes that made the company and its products better.

Partner - I'm an engaged collaborator and believe that building services and products is a team sport. <+> I work hard to be a trusted partner -- for the teams I lead, my peers, and the executive team who rely on my expertise. I approach working relationships and projects with curiosity and have a deep appreciation for healthy collaboration and the things we can accomplish when we've heard from multiple perspectives and are aligned in our purpose.
...
(Later, maybe also add in some job search tooling things here, too:
- Airtable template
- LI strategies
...
I’m most effective in environments that value collaboration and transparency. I see myself as a force multiplier for teams, bringing clarity and momentum to the work at hand and have nearly a decade’s worth of experience guiding teams to work better together.

I'm open to full-time roles or short-term consulting work based in the Baltimore region or remote and focused on mission-driven organizations.

<aside>I’m currently more focused on the impact I can have and the strength of the team I’m working alongside than the specifics of my title. However, if it helps, titles might look like: Chief of Staff, Technical Chief of Staff, VP of Engineering reporting to a CTO, senior positions in product operations or program management.</aside>

<aside>I'm similarly open to the shape of organization I work for. I have worked for startups with a headcount of 30-300 and also worked for the state of Maryland, which employs something like 116k people. I'm open to startups, public sector, and nonprofit opportunities and am primarily focused on education, mental health, civil rights, and community building, but open to other problem spaces.
...
- Leading with curiosity. I’m inquisitive and reflective and use these attributes to help build sense making across the organization – about what we’re building and how we do it.
-Data driven. Identifying metrics that matter for the business, teams, and myself.

You can find the details of my professional experience on [LinkedIn]() and my [resume]().

### What I'm looking for
- Good people working in a collaborative environment
- Meaningful, impactful work for an organization with a clear sense of its values
- Remote (where working East coast hours would be reasonable) or based in Baltimore

### Contact me
If you want to have a conversation about any of this, I'd be thrilled to hear from you. My LinkedIn DMs are open or you can contact me at hello@angeliqueweger.com.

I'd appreciate it if your message was specific about the organization you're contacting me about. As outlined above, the purpose and impact of my work is really critical to me, so being vague about the opportunity may waste both of our time.
